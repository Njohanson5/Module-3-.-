...
data = os.path.join('C:/Users/njohanson/OneDrive - Federal Signal Corporation/Desktop/NU-VIRT-DATA-PT-10-2023-U-LOLC/02-Homework/03-Python/Instructions/Starter_Code/PyPoll/Resources/election_data.csv')
...
with open(data) as csvfile:
    ...
    list = list(reader)
#count the number of rows after the header, to calculate the amt of votes. 
votes = [row[2] for row in list]
...
output_path = os.path.join(os.path)
